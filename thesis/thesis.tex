...
\aufgabenstellung{
    \begin{description}
        ...
        % conduct a literature review to identify research questions regarding
        % clickstream research, 
        \item[Requirements] To be added
        %asdfasdf
        \item[Keywords] Clickstream, User Browsing Behavior, Sequence Learning, Information Seeking Behavior
    \end{description}
}
\acknoledgement{
