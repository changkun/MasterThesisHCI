...
Nevertheless, it is still interesting to see how action paths are manifestation for multiple
participants. Fortunately, we observed there are intersections among multiple subjects.

\paragraph{Pattern of ``overlap''}
occurs when we observe the intersection of multiple participants.
